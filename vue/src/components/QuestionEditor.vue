<template>
  ...
  <div class="grid gap-3 grid-cols-12">
    ...
    <div class="mt-3 col-span-9">
      ...
      <input type="text" v-model="model.question" @change="dataChange" :id="'question_text_' + model.data"
    ...
    <div class="mt-3 col-span-3">
      ...
      <select id="question_type" v-model="model.type" @change="typeChange"
  ...
  <div class="mt-3 col-span-9">
    ...
    <textarea v-model="model.description" @change="dataChange" :id="'question_description_' + model.id"
      class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"/>
  </div>
